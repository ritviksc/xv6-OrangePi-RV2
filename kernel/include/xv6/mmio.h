...
// read mmio ops
static inline uint8 readb(void *addr)
{
...
static inline uint64 readq(void *addr)
{
  return *((volatile uint64 *)addr);
}

// write mmio ops
static inline void writeb(uint8 value, void *addr)
{
  *((volatile uint8 *)addr) = value;
}

static inline void writew(uint16 value, void *addr)
{
...
static inline void writeq(uint64 value, void *addr)
{
